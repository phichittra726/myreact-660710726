...
const TodoListFri = () => {
    // ข้อมูลที่จะแสดง
    const todos = [
        { id: 1, text: 'เข้าเรียนวิชา DBA', completed: true },
        { id: 2, text: 'ซักผ้า', completed: true },
        { id: 3, text: 'กินของหวาน 1 อย่าง', completed:  true },
        { id: 4, text: 'เดินเล่นผ่อนคลาย', completed: true },
